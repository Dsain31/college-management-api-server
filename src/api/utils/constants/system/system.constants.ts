export default class SystemConstants {
    ...
    public static readonly UPDATE_SUCCESS_MSG = 'Updated successfully';
    public static readonly ID_REQUIRE_MSG = 'User id is required';
    public static readonly USER_REJECT_MSG = 'Your account is rejected.';
    public static readonly APPLICATION_SUBMIT_SUCCESS_MSG = 'Application has been submitted';
